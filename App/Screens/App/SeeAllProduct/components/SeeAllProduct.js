            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
                <LinearGradient
                    ...
                    <View style={styles.lenerHeadingTxt}>
                        ...
                        {Language.RecommandedProducts}  {/* {props.productName} */}
                        </Text>
                    </View>
                </LinearGradient>
                                        ...
                                        <View>
                                            ...
                                            <View style={styles.namePriceCon}>
                                                ...
                                                <View style={styles.priceContainer}>
                                                    <Text numberOfLines={1} style={{ fontSize: 12, }}>{'\u20AC'}  {item.product_unit_price}</Text>
                                                    <Text  numberOfLines={1} style={styles.priceTxt}> {'\u20AC'} {spanishNumberFormatter.format(parseFloat((`${item.product_unit_price}`).replace(/,/g, '.')) + parseFloat((`${item.discount}`).replace(/,/g, '.')))}</Text>
                                                </View>
