    ...
    return (
        <View style={[styles.Container, { paddingTop: Platform.OS === 'ios' ? 20 : 2 }]}>
            ...
            <View style={styles.loginContainer}>
                <Text title style={{ fontSize: 20 }}>{Language.LOGIN}</Text>
                ...
                <View style={styles.dontHaveAccount}>
                    <Text style={styles.dontHaveAccountTxt}>{Language.dontHaveAcc}</Text>
                    <TouchableOpacity onPress={() => props.onPressSignUp()}>
                        <Text style={styles.registerTxt}> {Language.REGISTER}</Text>
                    </TouchableOpacity>
                </View>
                ...
                {Platform.OS === 'ios' ?
                    ...
                    <View style={styles.socialContianer}>
                        <TouchableOpacity onPress={() => props.onPressGoogleLogin()}>
